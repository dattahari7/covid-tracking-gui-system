...
def showdata():
    ...
    # cases = covid.get_status_by_country_name(countries)
    ...
    plt.legend(handles=[confirmed_patch, recovered_patch,
               active_patch, deaths_patch])
    ...
    for x in range(len(country_names)):
        ...
        if active[x] == None or recovered[x] == 0:
            active[x] = 0
            recovered[x] = 0
